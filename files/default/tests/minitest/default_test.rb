...
describe 'myface::default' do
  ...
  it "Enables and starts the Apache2 daemon" do
  ...
  # Verify that the myface apache config has been enabled:
  it "configures apache for myface" do
    link("#{node['apache']['dir']}/sites-enabled/myface.conf").must_exist.\
